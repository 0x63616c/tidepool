...
id: tckt_001
title: add slugify
goal: "add slugify(s: string): string in src/string.ts — lowercases, trims, spaces→'-', strips chars that aren't [a-z0-9-], collapses repeated '-'. Has a vitest spec covering those cases."
priority: 1
