...
/**
 * The doctor's decision core, tested against the three facts it consumes (the
 * gathering of those facts — clone, test, store query — is a thin seam above
 * this). PASS requires all three; each failure names its own reason.
 */
